...
<head>
    ...
    <title>Home - Rastorinte</title>
    <link rel="icon" type="image/x-icon" href="assets/rastorintefavicon.png">
    <link href="css/style.css" rel="stylesheet" type="text/css">
    <meta name="description" content="Tasty meals with excellent service">
    <meta name="keywords" content="Rastorinte, Restaurant">
    <meta name="author" content="Jan, Jami, Joonas, Otto">
</head>
<body>
<header>
